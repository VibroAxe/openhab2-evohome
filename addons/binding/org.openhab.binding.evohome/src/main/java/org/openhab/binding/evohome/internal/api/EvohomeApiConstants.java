...
public class EvohomeApiConstants {
    ...
    public static final String URL_V2_LOCATIONS     = "location/installationInfo?userId=%s&includeTemperatureControlSystems=True";// {userId}
    ...
    public static final String URL_V2_STATUS        = "location/%s/status?includeTemperatureControlSystems=True"; // {locationId}
